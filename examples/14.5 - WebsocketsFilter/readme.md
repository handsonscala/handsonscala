...
@@ -40,14 +55,18 @@ object MinimalApplication extends cask.MainRoutes:
...
+      for (conn, filter) <- openConnections do
...
@@ -39,7 +40,10 @@ object ExampleTests extends TestSuite:
...
@@ -64,6 +68,17 @@ object ExampleTests extends TestSuite:
