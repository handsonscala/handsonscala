...
index 793a314..ea642c4 100644
--- a/10.6 - Blog/build.sc	
+++ b/10.7 - ExtendedBlog/build.sc	
@@ -12,58 +12,66 @@ val postInfo = interp.watchValue {
     }
     .sortBy(_._1.toInt)
 }
...
- [10.9 - PostPdf](https://github.com/handsonscala/handsonscala/tree/v1/examples/10.9%20-%20PostPdf)