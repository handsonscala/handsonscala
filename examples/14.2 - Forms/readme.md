...
## Upstream Example: [14.1 - Mock](https://github.com/handsonscala/handsonscala/tree/v2/examples/14.1%20-%20Mock):
Diff:
```diff
diff --git a/14.1 - Mock/app/src/MinimalApplication.scala b/14.2 - Forms/app/src/MinimalApplication.scala
index 07a949f..1b815db 100644
...
@@ -24,4 +24,23 @@ object ExampleTests extends TestSuite:
...
- [14.3 - Ajax](https://github.com/handsonscala/handsonscala/tree/v2/examples/14.3%20-%20Ajax)