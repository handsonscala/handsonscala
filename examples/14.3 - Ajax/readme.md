...
## Upstream Example: [14.2 - Forms](https://github.com/handsonscala/handsonscala/tree/v2/examples/14.2%20-%20Forms):
Diff:
```diff
...
@@ -35,14 +29,16 @@ object MinimalApplication extends cask.MainRoutes:
     )
   )
...
@@ -25,22 +25,36 @@ object ExampleTests extends TestSuite:
...
-      val response1 = requests.post(host, data = (Map("name" -> "haoyi"): requests.RequestBlob), check = false)
...
- [14.4 - Websockets](https://github.com/handsonscala/handsonscala/tree/v2/examples/14.4%20-%20Websockets)