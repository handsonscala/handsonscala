...
@@ -17,37 +16,72 @@ object MinimalApplication extends cask.MainRoutes:
       ),
       body(
         div(cls := "container")(
-          h1("Scala Chat!"),
...
diff --git a/14.4 - Websockets/build.mill b/14.8 - CrawlerWebsite/build.mill
index ce45b51..6647ad8 100644
--- a/14.4 - Websockets/build.mill	
+++ b/14.8 - CrawlerWebsite/build.mill	
@@ -5,11 +5,11 @@ object app extends ScalaModule:
