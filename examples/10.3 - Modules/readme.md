...
## Upstream Example: [10.2 - Nonlinear](https://github.com/handsonscala/handsonscala/tree/v2/examples/10.2%20-%20Nonlinear):
Diff:
```diff
...
diff --git a/10.2 - Nonlinear/build.mill b/10.3 - Modules/build.mill
index 0082352..d017dae 100644
--- a/10.2 - Nonlinear/build.mill	
+++ b/10.3 - Modules/build.mill	
@@ -1,13 +1,15 @@
 import mill.*
