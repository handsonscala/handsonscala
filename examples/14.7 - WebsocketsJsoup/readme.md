...
@@ -22,14 +24,18 @@ object ExampleTests extends TestSuite:
...
@@ -54,16 +60,18 @@ object ExampleTests extends TestSuite:
...
diff --git a/14.4 - Websockets/build.mill b/14.7 - WebsocketsJsoup/build.mill
index ce45b51..4158d3b 100644
--- a/14.4 - Websockets/build.mill	
+++ b/14.7 - WebsocketsJsoup/build.mill	
@@ -11,5 +11,6 @@ object app extends ScalaModule:
 
     def mvnDeps = Seq(
       mvn"com.lihaoyi::utest:0.9.4",
-      mvn"com.lihaoyi::requests:0.9.0"
+      mvn"com.lihaoyi::requests:0.9.0",
+      mvn"org.jsoup:jsoup:1.13.1"
     )
